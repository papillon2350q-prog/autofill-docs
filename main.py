...
FONT_REGULAR = str(BASE_DIR / "AlegreyaSans-Light.ttf")
FONT_BOLD = str(BASE_DIR / "AlegreyaSans-Light.ttf")
...
FIELDS = {
    ...
    "processed_date":       {"x": 698, "y": 1131, "font_size": 15, "color": "#c41e3a", "bold": False},
}
